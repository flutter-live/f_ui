        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FSelectInput(
              ...
              data: [
                // FChipModel(id: 1, name: '1', message: '删除'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1sxdss'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1'),
                // FChipModel(id: 2, name: '2dsd'),
                // FChipModel(id: 1, name: '1sds'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1'),
                // FChipModel(id: 2, name: '2'),
                // FChipModel(id: 1, name: '1'),
