...
import 'package:f_ui/cascader/f_cascader.dart';
import 'package:flutter/material.dart' hide DropdownMenuItem;

/// @description: 级联选择器
///@date: 2021/1/12 08

class FuiCascader extends StatefulWidget {
  @override
  _FuiCascaderState createState() => _FuiCascaderState();
}

class _FuiCascaderState extends State<FuiCascader> {
  ...
  @override
  void initState() {
    basicController = TextEditingController(text: '1/12/111');
    basicFocusNode = FocusNode();
    xzController = TextEditingController(text: '1/12/111');
